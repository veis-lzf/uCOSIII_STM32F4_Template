...
//	(void*)LCD_ShowNum,"void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size)",
	(void*)ShowString,"void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p)",
	(void*)ShowString,"void LCD_Fast_DrawPoint(u16 x,u16 y,u16 color)",
...
//	(void*)LCD_ShowxNum,"void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode)",
	(void*)BSP_RTC_Set_Data,"BSP_RTC_Set_Data(uint16_t Year, uint8_t Month, uint8_t Data, uint8_t WeekDay)",
    (void*)BSP_RTC_Set_Time,"BSP_RTC_Set_Time(uint8_t Hours, uint8_t Minutes, uint8_t Seconds, uint8_t AM_PM)",
    (void*)RTC_AlarmA_Set,"RTC_AlarmA_Set(uint8_t Week,uint8_t Hours,uint8_t Minutes,uint8_t Seconds)"
};						  
///////////////////////////////////END///////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
//函数控制管理器初始化
