...
u16  ssd1289_GetPoint(u16 x, u16 y);                                                                //读点
void LCD_Clear(u16 color);
void LCD_Fill_Pic(u16 x, u16 y, u16 pic_H, u16 pic_V, const unsigned char* pic);
void BlockWrite(unsigned int Xstart, unsigned int Xend, unsigned int Ystart, unsigned int Yend);
void SetCursor(u16, u16);                                                                           //设置光标
u16  ReadID(void);                                                                                  //read id
void Draw_Circle(u16, u16, u8, u16);                                                                //画圆
void DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color);                                           //画线
void DrawRectangle(u16, u16, u16, u16, u16);                                                        //画矩形
void LCD_Fill(u16, u16, u16, u16, u16 color);                                                       //区域填充函数
...
void DrawRGBImage(uint16_t Xpos, uint16_t Ypos, uint16_t Xsize, uint16_t Ysize, u8 *pData) ;        //显示图片
